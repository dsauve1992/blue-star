...
export interface AddTickerToWatchlistResponseDto {
  watchlist: Watchlist;
}

@Injectable()
export class AddTickerToWatchlistUseCase {
  constructor(
  ...
  async execute(
    request: AddTickerToWatchlistRequestDto,
    authContext: AuthContext,
  ): Promise<AddTickerToWatchlistResponseDto> {
