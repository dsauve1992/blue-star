CREATE TABLE IF NOT EXISTS paper_trades (
    ...
    global_rs_rating SMALLINT CHECK (global_rs_rating BETWEEN 1 AND 99),
    industry_group_rs_rating SMALLINT CHECK (industry_group_rs_rating BETWEEN 1 AND 99),
    industry_group_quadrant VARCHAR(10) CHECK (
